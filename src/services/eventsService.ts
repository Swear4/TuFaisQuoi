...
export async function fetchEventsByCategory(category: string) {
  ...
  // Prefer the new categories[] column; fall back to legacy single category if the column isn't deployed yet.
...
/**
 * Récupérer le nombre d'événements à venir pour une catégorie
 */
